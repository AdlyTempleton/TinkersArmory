...
// Then sort on stack size
    ...
    public static void respawnItemWithParticles(World worldObj, EntityItem oldItem, ItemStack stack) {
        ...
        TArmory.proxy.networkWrapper.sendToAllAround(new PacketBurst(1, newEntity.posX, newEntity.posY, newEntity.posZ), new NetworkRegistry.TargetPoint(worldObj.provider.dimensionId, (int) oldItem.posX, (int) oldItem.posY, (int) oldItem.posZ, 32));
    ...
    public static void diamondBurst(Entity entity, String particle) {
        ...
        for (int i = 0; i < directions.length; i++) {
            ...
            TArmory.proxy.networkWrapper.sendToAllAround(new PacketBurst(corner, centerTuple, particle, 1, 1, 1, 1), new NetworkRegistry.TargetPoint(entity.worldObj.provider.dimensionId, entity.posX, entity.posY, entity.posZ, 32));
            TArmory.proxy.networkWrapper.sendToAllAround(new PacketBurst(corner, connectingCorner, particle, 1, 1, 1, 1), new NetworkRegistry.TargetPoint(entity.worldObj.provider.dimensionId, entity.posX, entity.posY, entity.posZ, 32));
            TArmory.proxy.networkWrapper.sendToAllAround(new PacketBurst(corner, topTuple, particle, 1, 1, 1, 1), new NetworkRegistry.TargetPoint(entity.worldObj.provider.dimensionId, entity.posX, entity.posY, entity.posZ, 32));
