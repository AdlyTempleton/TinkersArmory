package pixlepix.tarmory.registry;
...
public class BlockRegistry {
    ...
    public void registerClasses() {
        try {
            ...
            for (ClassPath.ClassInfo classInfo : classPath.getTopLevelClassesRecursive("pixlepix.tarmory.block")) {
            ...
            for (ClassPath.ClassInfo classInfo : classPath.getTopLevelClassesRecursive("pixlepix.tarmory.item")) {
